...
-	product_expiration_date - дата закінчення терміну придатності товару
...
- Зв’язок між категорією і товаром має тип багато до багатьох, оскільки одна категорія вміщує в себе багато продуктів, а один товар може належати до кількох категорій
...
- Фіксація ціни: Після оформлення замовлення ціна на товар залишається сталою навіть якщо на сайті вона зросла.
```mermaid
erDiagram
Brand {
  int brand_id PK
...
Product {
  ...
  datetime product_expiration_date
